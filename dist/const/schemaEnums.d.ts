...
export declare const enum EAUDIT {
...
export declare const enum EMONITORING {
...
export declare const enum EPULT {
...
export declare const enum ESEODO {
...
export declare const enum ESMPRIMARY {
...
export type TBDALLTABLES = `${EPGCATALOG | EINFORMATIONSCHEMA | EAUDIT | ECHECKROOM | ECONFA | ECONFIG | EKNOWLEGEBASE | EPULT | EMONITORING | ESEODO | ESMPRIMARY | EJIRA}`;
export type TBDMODTABLES = `alert.${string}` | `${EAUDIT | ECHECKROOM | ECONFA | ECONFIG | EKNOWLEGEBASE | EPULT | ESEODO | ESMPRIMARY | EJIRA}`;
