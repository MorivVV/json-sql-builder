export declare const enum EJIRA {
...
export declare const enum EPGCATALOG {
...
export declare const enum EINFORMATIONSCHEMA {
    columns = "information_schema.columns"
}
export declare const enum ECONFIG {
...
export declare const enum ECONFA {
    block = "confa.block",
    content = "confa.content",
    pages = "confa.pages"
}
export declare const enum ECHECKROOM {
...
export declare const enum EKNOWLEGEBASE {
